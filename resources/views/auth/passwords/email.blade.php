...
<html lang="fr" class="light">
  ...
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
            <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-center mb-5">recupérer votre compte</h2>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="intro-x login__input form-control py-3 mt-5 px-4 block @error('email') border border-red-500 @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
